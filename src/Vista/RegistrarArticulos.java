...
public class RegistrarArticulos extends javax.swing.JInternalFrame {
    ...
    public RegistrarArticulos(EntityManagerFactory emf, JDesktopPane jdp) {
        initComponents();
    ...
    private void jButtonRegistrarArticuloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistrarArticuloActionPerformed
        ...
        try {
            ...
            int ganancia = Integer.parseInt(jTextFieldPrecioVenta.getText())
                    - Integer.parseInt(jTextFieldPrecioCompra.getText());
    ...
    private void jTextFieldPrecioVentaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrecioVentaKeyPressed
        ...
        if (evt.isActionKey()) {
            ...
            jTextFieldGanancia.setText(String.valueOf(ganancia));
        }
