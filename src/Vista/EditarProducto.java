...
public class EditarProducto extends javax.swing.JInternalFrame {
    ...
    public EditarProducto(EntityManagerFactory emf, JDesktopPane jdp, Productos p) {
        initComponents();
    ...
    private void jButtonGuardarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarProductoActionPerformed
        ...
        try {
            ...
            p.setDescripcionProducto(jTextAreaDesciripcionProducto.getText());
            p.setNombreProducto(jTextFieldNombreProducto.getText());
